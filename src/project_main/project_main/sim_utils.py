...
# added "rot" in order to control the orientation of the sensor at spawn moment (in sdf_launch.py file)
def spawn_sdf(sdf_input, id : int = None, pos : tuple = (0, 0, 0), rot = (0, 0, 0), world_name : str =  WORLD_NAME):
